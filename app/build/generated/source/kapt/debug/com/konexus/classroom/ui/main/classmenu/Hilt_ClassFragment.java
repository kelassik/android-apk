...
public abstract class Hilt_ClassFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClassFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClassFragment_GeneratedInjector) this.generatedComponent()).injectClassFragment(UnsafeCasts.<ClassFragment>unsafeCast(this));
    }
  }
